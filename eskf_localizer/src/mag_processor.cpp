...
void MagProcessor::Mag_correct(const MagDataPtr MagData, State* state){
	...
	ROS_INFO("q0 = %f,%f,%f,%f \t q1 = %f,%f,%f,%f",q0.w(),q0.x(),q0.y(),q0.z(),q1.w(),q1.x(),q1.y(),q1.z());
	state->G_R_I = q0.slerp(0.01,q1).normalized().toRotationMatrix();

	state->P.block<3,3>(6,6) *= 0.999;
